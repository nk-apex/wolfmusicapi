...
const spotifyEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/spotify/track/:id", method: "GET", description: "Get detailed track info by Spotify track ID", params: [{ name: "id", type: "string", required: true, description: "Spotify track ID (e.g. 0VjIjW4GlUZAMYd2vXMi3b)" }], format: "json", category: "spotify", provider: "Spotify API" },
  { path: "/api/spotify/album/:id", method: "GET", description: "Get album info and full track listing by Spotify album ID", params: [{ name: "id", type: "string", required: true, description: "Spotify album ID" }], format: "json", category: "spotify", provider: "Spotify API" },
  { path: "/api/spotify/artist/:id", method: "GET", description: "Get artist info by Spotify artist ID", params: [{ name: "id", type: "string", required: true, description: "Spotify artist ID" }], format: "json", category: "spotify", provider: "Spotify API" },
  { path: "/api/spotify/artist/:id/top-tracks", method: "GET", description: "Get an artist's top tracks by Spotify artist ID", params: [{ name: "id", type: "string", required: true, description: "Spotify artist ID" }], format: "json", category: "spotify", provider: "Spotify API" },
  { path: "/api/spotify/playlist/:id", method: "GET", description: "Get playlist info and full track listing by Spotify playlist ID", params: [{ name: "id", type: "string", required: true, description: "Spotify playlist ID" }], format: "json", category: "spotify", provider: "Spotify API" },
  { path: "/api/spotify/info/search", method: "GET", description: "Search Spotify via GraphQL for tracks, albums, artists or playlists", params: [{ name: "q", type: "string", required: true, description: "Search query" }, { name: "type", type: "string", required: false, description: "Result type: track | album | artist | playlist (default: track)" }, { name: "limit", type: "string", required: false, description: "Max results (1–50, default: 20)" }, { name: "offset", type: "string", required: false, description: "Pagination offset (default: 0)" }], format: "json", category: "spotify", provider: "Spotify API" },
];
