...
const aiToolEndpoints: ApiEndpoint[] = [
  ...
  { path: "/api/ai/tools/image-edit", method: "GET", description: "Edit or transform an existing image by describing it and specifying what to change — generates a new AI-edited version via Pollinations", params: [{ name: "description", type: "string", required: true, description: "Describe what your current image looks like", default: "a wolf standing in a snowy forest at night" }, { name: "edit_prompt", type: "string", required: true, description: "What you want to change or add (e.g. 'make it daytime', 'add cherry blossoms', 'change to cyberpunk city')", default: "make it a glowing cyberpunk city at night with neon lights" }, { name: "style", type: "string", required: false, description: "Optional output style: realistic | anime | ghibli | oil-painting | cartoon | dark", default: "realistic" }, { name: "ratio", type: "string", required: false, description: "Aspect ratio: 1:1 | 16:9 | 9:16 | 4:3 | 3:4 (default 1:1)", default: "1:1" }], format: "json", category: "ai-tools", provider: "Pollinations + ChatEverywhere" },
];
