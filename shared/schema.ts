...
const movieEndpoints: ApiEndpoint[] = [
  { path: "/api/xcasper/search", method: "GET", description: "Search movies & TV shows by title", params: [{ name: "q", type: "string", required: true, description: "Movie or show title", default: "Avatar" }, { name: "type", type: "string", required: false, description: "Filter: movie or tv (default: all)", default: "movie" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }, { name: "perPage", type: "string", required: false, description: "Results per page (default: 10)", default: "10" }], format: "json", category: "movie", provider: "XCasper" },
  { path: "/api/xcasper/trailer", method: "GET", description: "Get a direct MP4 trailer URL for any movie or TV show", params: [{ name: "id", type: "string", required: true, description: "subjectId from /api/xcasper/search results", default: "1234376946650333432" }], format: "json", category: "movie", provider: "XCasper" },
  ...
  { path: "/api/xcasper/ranking", method: "GET", description: "Get the list of ranking categories (Popular, Action, Horror, Romance, Nollywood, etc.)", params: [], format: "json", category: "movie", provider: "XCasper" },
  { path: "/api/xcasper/ranking-content", method: "GET", description: "Get movies/shows in a specific ranking category by ID or genre name", params: [{ name: "id", type: "string", required: false, description: "Ranking category ID from /api/xcasper/ranking (use this or genre)", default: "997144265920760504" }, { name: "genre", type: "string", required: false, description: "Genre name shorthand: Action | Horror | Comedy | Romance | Nollywood | Adventure", default: "Action" }, { name: "page", type: "string", required: false, description: "Page number (default: 1)", default: "1" }, { name: "perPage", type: "string", required: false, description: "Results per page (default: 12)", default: "12" }], format: "json", category: "movie", provider: "XCasper" },
];
